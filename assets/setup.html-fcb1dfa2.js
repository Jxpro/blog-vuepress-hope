import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as e,e as a}from"./app-5e6e2e94.js";const i={},l=a(`<h1 id="阿里云linux服务器安装docker" tabindex="-1"><a class="header-anchor" href="#阿里云linux服务器安装docker" aria-hidden="true">#</a> 阿里云Linux服务器安装Docker</h1><h2 id="一、使用官方安装脚本自动安装-仅适用于公网环境" tabindex="-1"><a class="header-anchor" href="#一、使用官方安装脚本自动安装-仅适用于公网环境" aria-hidden="true">#</a> 一、使用官方安装脚本自动安装 （仅适用于公网环境）</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-fsSL</span> https://get.docker.com <span class="token operator">|</span> <span class="token function">bash</span> <span class="token parameter variable">-s</span> <span class="token function">docker</span> <span class="token parameter variable">--mirror</span> Aliyun
