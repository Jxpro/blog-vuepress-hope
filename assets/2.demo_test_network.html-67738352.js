import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o,c as p,a as n,b as s,d as e,e as t}from"./app-24ed71cb.js";const c={},r=n("h1",{id:"fabric案例-test-network",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#fabric案例-test-network","aria-hidden":"true"},"#"),s(" Fabric案例 - test-network")],-1),d={id:"一、network-sh-命令帮助",tabindex:"-1"},u=n("a",{class:"header-anchor",href:"#一、network-sh-命令帮助","aria-hidden":"true"},"#",-1),v={href:"http://network.sh",target:"_blank",rel:"noopener noreferrer"},m=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>./network.sh <span class="token parameter variable">-h</span>
